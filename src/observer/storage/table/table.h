...
public:
  ...
  RC update_record(Record &record, vector<Value> values, vector<FieldMeta> fields);

  RC recover_insert_record(Record &record);

  // TODO refactor
  RC create_index(Trx *trx, const bool unique, const vector<const FieldMeta *> &field_metas, const char *index_name);
